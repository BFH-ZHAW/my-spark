...
//          Original:
          ...
          StructType eventsSchema = DataTypes
            ...
            lines.add(RowFactory.create(  Array.get(((String[]) results.get(0)), i ) //"id",
			              			+";"+ Array.get(((String[]) results.get(1)), i ) // "date"
			              			+";"+ Array.get(((String[]) results.get(2)), i ) // "type"
			              			+";"+ Array.get(((String[]) results.get(3)), i ) // "currency"
			              			+";"+ Array.get(((String[]) results.get(4)), i ) // "value"
			              			+";"+ Array.get(((Double[]) results.get(5)), i ) // "nominal"
			              			+";"+ Array.get(((Double[]) results.get(6)), i ) // "accrued"
			              			));
            }
