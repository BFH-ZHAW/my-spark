/**
Erweiterung von: MapContractsJob_V3_0 -> Partition 
...
public class MapContractsJob_V3_1 {
	...
	public static void main(String[] args) {
	    ...
	    // import risk factor data as Dataframe and count
	   	...
	   	riskfactorsFile.repartition(riskfactorsFile.col("MarketObjectCode"));
	    ...
	    if(debug.equals("debug")){
	   	...
	   	contractsFile.repartition(contractsFile.col("marketObjectCodeRateReset"));
	   	
	  //Debug Information
	    if(debug.equals("debug")){
	    	System.out.println("contractsFile printSchema() und show() von Total:"+contractsFile.count()+" Contracts");
