...
public class MapFunction_V1 implements FlatMapFunction<String, Row> {
	ZonedDateTime t0;
	Map<String, String[]> riskFactors;

	public MapFunction_V1(ZonedDateTime t0, Map<String, String[]> riskFactors) {
		this.t0 = t0;
	...
	private static RiskFactorConnector mapRF(Map<String, String[]> rfData, String marketObjectCodeRateReset,
