...
public class HDFS_Performance_V0_1 {
	...
	public static void main(String[] args) {
		...
		String className = "com.bruttel.actus.HDFS_Performance_V0_1";
		...
		if (debug.equals("debug")) {
			System.out.println("Pfad:" + contractsPath );
		}
