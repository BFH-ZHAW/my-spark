...
public class CallculateMarketValue_V1_0 {
	...
	public static void main(String[] args) {
		...
		String className = "com.bruttel.actus.CallculateMarketValue_V1_0";
		...
		//Accumulate Values
		Dataset<Row> marketValuesMean = marketValues.groupBy("portfolio")
		...
		// Debug Info
		if (debug.equals("debug")) {
	    	System.out.println("events marketValuesMean");
