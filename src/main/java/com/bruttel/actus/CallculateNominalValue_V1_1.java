...
Datenverarbeitung: Dataframe -> Nested
Output: Liste
Input: parquet
...
public class CallculateNominalValue_V1_1 {
	...
	public static void main(String[] args) {
		...
		String className = "com.bruttel.actus.CallculateNominalValue_V1_1";
	    ...
	    if(output.equals("parquet")){
	    	nominalValues.write().mode(SaveMode.Overwrite).parquet(outputPath + "nominalValues.parquet");
	    }
	    else {
	    	nominalValues.write().mode(SaveMode.Overwrite).csv(outputPath + "nominalValues.csv");
	    }
