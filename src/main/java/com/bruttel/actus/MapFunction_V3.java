...
public class MapFunction_V3 implements FlatMapFunction<Row, Row> {
	ZonedDateTime t0;
	...
	public MapFunction_V3(ZonedDateTime t0) {
		this.t0 = t0;
		...
		try {
			if (!marketObjectCodeRateReset.equals("NULL")) {
				...
				if (rfData.getString(47).equals("TermStructure")) {
					curve.of(t0, PeriodConverter.of(rfData.getString(48).split("!")),
							DoubleConverter.ofArray(rfData.getString(49), "!"));
					rfCon.add(rfData.getString(45), curve);
				} else if (rfData.getString(47).equals("ReferenceRate")) {
					refRate.of(DateConverter.of(rfData.getString(48).split("!")),
							DoubleConverter.ofDoubleArray(rfData.getString(49), "!"));
			...
			if (!marketObjectCodeScaling.equals("NULL")) {
				...
				// rf = rfData;
				refIndex.of(DateConverter.of(rfData.getString(48).split("!")),
						DoubleConverter.ofDoubleArray(rfData.getString(49), "!"));
